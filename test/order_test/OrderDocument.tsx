...
import { CalendarIcon, Check, ChevronsUpDown, GripVertical, PlusCircle, X } from "lucide-react";
...
// ---------------------------------------------------------------------------
// Date picker popover for A4 stop date fields
// ---------------------------------------------------------------------------
      ...
      <div className={`${ROW_526} h-[17px]`}>
        ...
        >
          ...
          {disabled ? (
            ...
            >
              {stop.time ? stop.time.substring(0, 5) : ""}
            </span>
          ) : (
            <input
              type="time"
              value={stop.time ? stop.time.substring(0, 5) : ""}
              onChange={(e) =>
