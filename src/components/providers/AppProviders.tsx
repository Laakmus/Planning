 ...
 *   `MicrosoftAuthProvider` (MSAL frontend) został usunięty — integracja
 *   z Microsoft 365 jest teraz realizowana w pełni server-side (OAuth2
 *   Authorization Code + PKCE, endpoints `/api/v1/ms-oauth/*`). Frontend
 *   konsumuje tylko JSON status / call do `/prepare-email-graph`.
 */
