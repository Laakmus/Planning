...
export default function StatusFooter({
  ...
  return (
    <footer className="shrink-0 h-10 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 z-50">
