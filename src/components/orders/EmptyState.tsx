...
export function EmptyState({
  ...
  if (hasFilters) {
    return (
      <div data-testid="empty-state" className="border-2 border-dashed border-slate-300 dark:border-slate-800 rounded-xl py-16 flex flex-col items-center justify-center text-center mx-4 my-4">
